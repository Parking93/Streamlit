...
def main():
    ...
    for i in range(len(stock_list)):
        stock_value = fdr.DataReader(stock_list[i], start_date_str, end_date_str)["Close"].iloc[-1]
        stock_value = fdr.DataReader(stock_list[i], start_date_str, end_date_str)["Close"].iloc[-2]
