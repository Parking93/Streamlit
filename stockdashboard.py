...
def main():
    ...
    for i in range(len(stock_list)):
        ...
        stock_diff = fdr.DataReader(stock_list[i], start_date_str, end_date_str)["Close"].loc[end_date_str]-fdr.DataReader(stock_list[i], start_date_str, end_date_str)["Close"].loc[start_date_str]
        st.metric(label=f'{stock[i]}', value=f'{stock_value}원', delta=f'{stock_diff}원')
